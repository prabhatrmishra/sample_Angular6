/*! ceUIkit 3.0.0-rc.6 | http://www.getuikit.com | (c) 2014 - 2017 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global.ceUIkit = factory());
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'ce-transition');
                    css(element, {
                        'transition-property': '',
                        'transition-duration': '',
                ...
                addClass(element, 'ce-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'ce-transition');
        }

    };

    var animationPrefix = 'ce-animation-';
    var clsCancelAnimation = 'ce-cancel-animation';
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    ...
                    if (origin) {
                        cls += " ce-transform-origin-" + origin;
                    }
    ...
    */
    ...
    function componentAPI (ceUIkit) {

        var DATA = ceUIkit.data;

        var components = {};

        ceUIkit.component = function (name, options) {

            if (!options) {

                if (isPlainObject(components[name])) {
                    components[name] = ceUIkit.extend(components[name]);
                }
            ...
            ceUIkit[name] = function (element, data$$1) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = ceUIkit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = ceUIkit.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(ceUIkit, opt, name);
            }

            if (ceUIkit._initialized && !opt.functional) {
                var id = hyphenate(name);
                fastdom.read(function () { return ceUIkit[name](("[ce-" + id + "],[data-ce-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        ceUIkit.getComponents = function (element) { return element && element[DATA] || {}; };
        ceUIkit.getComponent = function (element, name) { return ceUIkit.getComponents(element)[name]; };

        ceUIkit.connect = function (node) {
        ...
        ceUIkit.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    function getComponentName(attribute) {
        return startsWith(attribute, 'ce-') || startsWith(attribute, 'data-ce-')
            ? camelize(attribute.replace('data-ce-', '').replace('ce-', ''))
            : false;
    }

    function boot (ceUIkit) {

        var connect = ceUIkit.connect;
        var disconnect = ceUIkit.disconnect;
        ...
        function applyAttribute(ref) {
            ...
            var component = ceUIkit.getComponent(target, name);
        ...
        function apply$$1(node, fn) {
            ...
            if (node.nodeType !== 1 || hasAttr(node, 'ce-no-boot')) {
                return;
            }
    ...
    function globalAPI (ceUIkit) {

        var DATA = ceUIkit.data;

        ceUIkit.use = function (plugin) {
        ...
        ceUIkit.mixin = function (mixin, component) {
            component = (isString(component) ? ceUIkit.component(component) : component) || this;
        ...
        ceUIkit.extend = function (options) {

            options = options || {};

            var Super = this;
            var Sub = function ceUIkitComponent (options) {
                this._init(options);
            };
        ...
        ceUIkit.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(ceUIkit, 'container', {
    ...
    function hooksAPI (ceUIkit) {

        ceUIkit.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        ceUIkit.prototype._callConnected = function () {
            var this$1 = this;
        ...
        ceUIkit.prototype._callDisconnected = function () {
        ...
        ceUIkit.prototype._callReady = function () {
        ...
        ceUIkit.prototype._callUpdate = function (e) {
            var this$1 = this;
    ...
    function stateAPI (ceUIkit) {

        var uid = 0;

        ceUIkit.prototype._init = function (options) {
        ...
        ceUIkit.prototype._initData = function () {
            var this$1 = this;
        ...
        ceUIkit.prototype._initMethods = function () {
            var this$1 = this;
        ...
        ceUIkit.prototype._initComputeds = function () {
            var this$1 = this;
        ...
        ceUIkit.prototype._resetComputeds = function () {
            this._computeds = {};
        };

        ceUIkit.prototype._initProps = function (props) {
            var this$1 = this;
        ...
        ceUIkit.prototype._initEvents = function () {
            var this$1 = this;
        ...
        ceUIkit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            this._events = [];
        };

        ceUIkit.prototype._initObserver = function () {
            var this$1 = this;
    ...
    function instanceAPI (ceUIkit) {

        var DATA = ceUIkit.data;

        ceUIkit.prototype.$mount = function (el) {
        ...
        ceUIkit.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        ceUIkit.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        ceUIkit.prototype.$destroy = function (removeEl) {
        ...
        ceUIkit.prototype.$create = function (component, element, data$$1) {
            return ceUIkit[component](element, data$$1);
        };

        ceUIkit.prototype.$update = ceUIkit.update;
        ceUIkit.prototype.$getComponent = ceUIkit.getComponent;

        var names = {};
        Object.defineProperties(ceUIkit.prototype, {

            $container: Object.getOwnPropertyDescriptor(ceUIkit, 'container'),
            ...
            $name: {
                ...
                get: function() {
                    ...
                    if (!names[name]) {
                        names[name] = ceUIkit.prefix + hyphenate(name);
                    }
    ...
    var ceUIkit = function (options) {
        this._init(options);
    };

    ceUIkit.util = util;
    ceUIkit.data = '__uikit__';
    ceUIkit.prefix = 'ce-';
    ceUIkit.options = {};
            ...
            toggleElement: function(targets, show, animate$$1) {
                ...
                return new Promise$1(function (resolve) {
                    ...
                    if (!this$1.queued || !isUndefined(animate$$1) || !isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = Animation.inProgress(el) && hasClass(el, 'ce-animation-leave')
            ...
            _toggleElement: function(el, show, animate$$1) {
                ...
                show = isBoolean(show)
                    ...
                    : Animation.inProgress(el)
                        ? hasClass(el, 'ce-animation-leave')
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'ce-open',
            toggle: '> .ce-accordion-title',
            content: '> .ce-accordion-content',
            transition: 'ease'
        },
    ...
    function Core (ceUIkit) {
        ...
        ready(function () {
            ...
            on(window, 'load resize', function (e) { return ceUIkit.update(null, e); });
            on(window, 'scroll', function (e) {
                e.dir = scroll <= window.pageYOffset ? 'down' : 'up';
                e.pageYOffset = scroll = window.pageYOffset;
                ceUIkit.update(null, e);
            }, {capture: true, passive: false});

            on(document, 'animationstart', function (ref) {
                var target = ref.target;

                if ((css(target, 'animationName') || '').match(/^ce-.*(left|right)/)) {
            ...
            Object.defineProperty(ceUIkit, 'hoverSelector', {
            ...
            ceUIkit.hoverSelector = '.ce-animation-toggle, .ce-transition-toggle, [ce-hover]';
    ...
    var Drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("ce-" + (this.$options.name));
            },
...

            {
                ...
                handler: function(ref) {
                    ...
                    if (current === this.input) {
                        toggleClass(
                            this.state,
                            ("ce-" + (includes(type, 'focus') ? 'focus' : 'hover')),
    ...
    var Margin = {
        ...
        data: {
            margin: 'ce-margin-small-top',
            firstColumn: 'ce-first-column'
        },
    ...
    var Grid = {
        ...
        data: {
            margin: 'ce-grid-margin',
            clsStack: 'ce-grid-stack',
            masonry: false,
            parallax: 0
        },
        ...
        connected: function() {
            this.masonry && addClass(this.$el, 'ce-flex-top ce-flex-wrap-top');
        },
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'ce-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'ce-search-icon') && parents($el, '.ce-search-large').length
                    ? 'search-large'
                    : parents($el, '.ce-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'ce-close-large') ? 'large' : 'icon'));
            }
    ...
    function install(ceUIkit) {
        ceUIkit.icon.add = function (name, svg) {
            var obj;
            ...
            if (ceUIkit._initialized) {
                apply(document.body, function (el) { return each(ceUIkit.getComponents(el), function (cmp) { return cmp.$options.isIcon && cmp.icon in added && cmp.$reset(); }
                    ); }
                );
            }
        };
    ...
    var Leader = {
        ...
        data: {
            fill: '',
            media: false,
            clsWrapper: 'ce-leader-fill',
            clsHide: 'ce-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    var Modal$1 = {
        ...
        data: {
            clsPage: 'ce-modal-page',
            selPanel: '.ce-modal-dialog',
            selClose: '.ce-modal-close, .ce-modal-close-default, .ce-modal-close-outside, .ce-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function() {
                    ...
                    if (hasClass(this.panel, 'ce-margin-auto-vertical')) {
                        addClass(this.$el, 'ce-flex');
                    } else {
    ...
    function install$1 (ceUIkit) {

        ceUIkit.modal.dialog = function (content, options) {

            var dialog = ceUIkit.modal((" <div class=\"ce-modal\"> <div class=\"ce-modal-dialog\">" + content + "</div> </div> "), options);
        ...
        ceUIkit.modal.alert = function (message, options) {

            options = assign({bgClose: false, escClose: false, labels: ceUIkit.modal.labels}, options);

            return new Promise$1(
                function (resolve) { return on(ceUIkit.modal.dialog((" <div class=\"ce-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"ce-modal-footer ce-text-right\"> <button class=\"ce-button ce-button-primary ce-modal-close\" autofocus>" + (options.labels.ok) + "</button> </div> "), options).$el, 'hide', resolve); }
            );
        };

        ceUIkit.modal.confirm = function (message, options) {

            options = assign({bgClose: false, escClose: true, labels: ceUIkit.modal.labels}, options);

            return new Promise$1(function (resolve, reject) {

                var confirm = ceUIkit.modal.dialog((" <form> <div class=\"ce-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"ce-modal-footer ce-text-right\"> <button class=\"ce-button ce-button-default ce-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"ce-button ce-button-primary\" autofocus>" + (options.labels.ok) + "</button> </div> </form> "), options);
        ...
        ceUIkit.modal.prompt = function (message, value, options) {

            options = assign({bgClose: false, escClose: true, labels: ceUIkit.modal.labels}, options);

            return new Promise$1(function (resolve) {

                var prompt = ceUIkit.modal.dialog((" <form class=\"ce-form-stacked\"> <div class=\"ce-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"ce-input\" autofocus> </div> <div class=\"ce-modal-footer ce-text-right\"> <button class=\"ce-button ce-button-default ce-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"ce-button ce-button-primary\">" + (options.labels.ok) + "</button> </div> </form> "), options),
    ...
    var Navbar = {
        ...
        data: {
            dropdown: '.ce-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'ce-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
        ...
        beforeConnect: function() {
            ...
            this.dropbar = dropbar && (query(dropbar, this.$el) || $('+ .ce-navbar-dropbar', this.$el) || $('<div></div>'));

            if (this.dropbar) {

                addClass(this.dropbar, 'ce-navbar-dropbar');

                if (this.dropbarMode === 'slide') {
                    addClass(this.dropbar, 'ce-navbar-dropbar-slide');
                }
            }
    ...
    var Offcanvas = {
        ...
        data: {
            content: '.ce-offcanvas-content',
            mode: 'slide',
            flip: false,
            overlay: false,
            clsPage: 'ce-offcanvas-page',
            clsContainer: 'ce-offcanvas-container',
            selPanel: '.ce-offcanvas-bar',
            clsFlip: 'ce-offcanvas-flip',
            clsContent: 'ce-offcanvas-content',
            clsContentAnimation: 'ce-offcanvas-content-animation',
            clsSidebarAnimation: 'ce-offcanvas-bar-animation',
            clsMode: 'ce-offcanvas',
            clsOverlay: 'ce-offcanvas-overlay',
            selClose: '.ce-offcanvas-close'
        },
    ...
    var Responsive = {
        ...
        connected: function() {
            addClass(this.$el, 'ce-responsive-width');
        },
    ...
    var Scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'ce-scrollspy-inview'
        }); },
                ...
                read: function(els) {
                    ...
                    this.elements.forEach(function (el, i) {
                        ...
                        if (!elData || elData.el !== el) {
                            var cls = data(el, 'ce-scrollspy-class');
    ...
    var Sticky = {
        ...
        data: {
            ...
            clsActive: 'ce-active',
            clsInactive: '',
            clsFixed: 'ce-sticky-fixed',
            clsBelow: 'ce-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            media: false,
        ...
        connected: function() {
            ...
            this.placeholder = $('+ .ce-sticky-placeholder', this.$el) || $('<div class="ce-sticky-placeholder"></div>');
    ...
    var Switcher = {
        ...
        data: {
            ...
            swiping: true,
            cls: 'ce-active',
            clsContainer: 'ce-switcher',
            attrItem: 'ce-switcher-item',
            queued: true
        },
        ...
        events: [

            {
                ...
                delegate: function() {
                    return ((this.toggle) + ":not(.ce-disabled)");
                },
        ...
        methods: {
            ...
            show: function(item) {
                ...
                for (var i = 0; i < length; i++, next = (next + dir + length) % length) {
                    if (!matches(this$1.toggles[next], '.ce-disabled, [disabled]')) {
    ...
    var Tab = {
        ...
        data: {
            media: 960,
            attrItem: 'ce-tab-item'
        },

        connected: function() {

            var cls = hasClass(this.$el, 'ce-tab-left')
                ? 'ce-tab-left'
                : hasClass(this.$el, 'ce-tab-right')
                    ? 'ce-tab-right'
                    : false;
    ...
    function core (ceUIkit) {
        ...
        // core components
        ceUIkit.component('accordion', Accordion);
        ceUIkit.component('alert', Alert);
        ceUIkit.component('cover', Cover);
        ceUIkit.component('drop', Drop);
        ceUIkit.component('dropdown', Dropdown);
        ceUIkit.component('formCustom', FormCustom);
        ceUIkit.component('gif', Gif);
        ceUIkit.component('grid', Grid);
        ceUIkit.component('heightMatch', HeightMatch);
        ceUIkit.component('heightViewport', HeightViewport);
        ceUIkit.component('icon', Icon);
        ceUIkit.component('img', Img);
        ceUIkit.component('leader', Leader);
        ceUIkit.component('margin', Margin);
        ceUIkit.component('modal', Modal$1);
        ceUIkit.component('nav', Nav);
        ceUIkit.component('navbar', Navbar);
        ceUIkit.component('offcanvas', Offcanvas);
        ceUIkit.component('overflowAuto', OverflowAuto);
        ceUIkit.component('responsive', Responsive);
        ceUIkit.component('scroll', Scroll);
        ceUIkit.component('scrollspy', Scrollspy);
        ceUIkit.component('scrollspyNav', ScrollspyNav);
        ceUIkit.component('sticky', Sticky);
        ceUIkit.component('svg', SVG);
        ceUIkit.component('switcher', Switcher);
        ceUIkit.component('tab', Tab);
        ceUIkit.component('toggle', Toggle);
        ceUIkit.component('video', Video);

        // Icon components
        ceUIkit.component('close', Close);
        ceUIkit.component('marker', IconComponent);
        ceUIkit.component('navbarToggleIcon', IconComponent);
        ceUIkit.component('overlayIcon', IconComponent);
        ceUIkit.component('paginationNext', IconComponent);
        ceUIkit.component('paginationPrevious', IconComponent);
        ceUIkit.component('searchIcon', Search);
        ceUIkit.component('slidenavNext', Slidenav);
        ceUIkit.component('slidenavPrevious', Slidenav);
        ceUIkit.component('spinner', Spinner);
        ceUIkit.component('totop', IconComponent);
    ...
    var targetClass = 'ce-animation-target';
        ...
        update: [

            {
                ...
                write: function() {
                    ...
                    toggleClass($$(this.navItemSelector, this.$el).concat(this.nav), 'ce-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'ce-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'ce-transition-active',
    ...
    var LightboxPanel = {
        ...
        data: function () { return ({
            ...
            items: [],
            cls: 'ce-open',
            clsPage: 'ce-lightbox-page',
            selList: '.ce-lightbox-items',
            attrItem: 'ce-lightbox-item',
            selClose: '.ce-close-large',
            pauseOnHover: false,
            velocity: 2,
            Animations: Animations$1,
            template: "<div class=\"ce-lightbox ce-overflow-hidden\"> <ul class=\"ce-lightbox-items\"></ul> <div class=\"ce-lightbox-toolbar ce-position-top ce-text-right ce-transition-slide-top ce-transition-opaque\"> <button class=\"ce-lightbox-toolbar-icon ce-close-large\" type=\"button\" ce-close></button> </div> <a class=\"ce-lightbox-button ce-position-center-left ce-position-medium ce-transition-fade\" href=\"#\" ce-slidenav-previous ce-lightbox-item=\"previous\"></a> <a class=\"ce-lightbox-button ce-position-center-right ce-position-medium ce-transition-fade\" href=\"#\" ce-slidenav-next ce-lightbox-item=\"next\"></a> <div class=\"ce-lightbox-toolbar ce-lightbox-caption ce-position-bottom ce-text-center ce-transition-slide-bottom ce-transition-opaque\"></div> </div>"
        }); },
        ...
        created: function() {
            ...
            this.caption = $('.ce-lightbox-caption', this.$el);
        ...
        events: [
...

            {
                ...
                handler: function(_, item) {
                    ...
                    this.setItem(item, '<span ce-spinner></span>');
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        var video = $(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " ce-video=\"" + (this.videoAutoplay) + "\"></video>"));
                        ...
                        this.setItem(item, ("<iframe class=\"ce-lightbox-iframe\" src=\"" + source + "\" frameborder=\"0\" allowfullscreen></iframe>"));
        ...
        methods: {
            ...
            setError: function(item) {
                this.setItem(item, '<span ce-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'ce-active', 'ce-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'ce-active', 'ce-transition-active');
            }
    ...
    function getIframe(src, width$$1, height$$1, autoplay) {
        return ("<iframe src=\"" + src + "\" width=\"" + width$$1 + "\" height=\"" + height$$1 + "\" style=\"max-width: 100%; box-sizing: border-box;\" frameborder=\"0\" allowfullscreen ce-video=\"autoplay: " + autoplay + "\" ce-responsive></iframe>");
    }
    ...
    function install$2(ceUIkit, Lightbox) {

        if (!ceUIkit.lightboxPanel) {
            ceUIkit.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            ceUIkit.component('lightboxPanel').options.props
        );
    ...
    var Notification = {
        ...
        data: {
            ...
            group: null,
            pos: 'top-center',
            clsClose: 'ce-notification-close',
            clsMsg: 'ce-notification-message'
        },
        ...
        created: function() {
            ...
            if (!containers[this.pos]) {
                containers[this.pos] = append(this.$container, ("<div class=\"ce-notification ce-notification-" + (this.pos) + "\"></div>"));
            }

            var container = css(containers[this.pos], 'display', 'block');

            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href=\"#\" class=\"" + (this.clsClose) + "\" data-ce-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install$3(ceUIkit) {
        ceUIkit.notification.closeAll = function (group, immediate) {
            apply(document.body, function (el) {
                var notification = ceUIkit.getComponent(el, 'notification');
    ...
    var Slider$1 = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'ce-slider-item',
            selList: '.ce-slider-items',
            selNav: '.ce-slider-nav',
            clsContainer: 'ce-slider-container',
        ...
        update: {
            ...
            write: function() {
                ...
                $$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && toggleClass(el, 'ce-hidden', isNumeric(index$$1) && (this$1.sets && !includes(this$1.sets, toFloat(index$$1)) || index$$1 > this$1.maxIndex));
                });
    ...
    var Slideshow$1 = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.ce-slideshow-items',
            attrItem: 'ce-slideshow-item',
            selNav: '.ce-slideshow-nav',
    ...
    var Sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'ce-sortable-item',
            clsPlaceholder: 'ce-sortable-placeholder',
            clsDrag: 'ce-sortable-drag',
            clsDragState: 'ce-drag',
            clsBase: 'ce-sortable',
            clsNoDrag: 'ce-sortable-nodrag',
            clsEmpty: 'ce-sortable-empty',
            clsCustom: '',
            handle: false
        },
    ...
    var Tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['ce-animation-scale-up'],
            duration: 100,
            cls: 'ce-active',
            clsPos: 'ce-tooltip'
        },
    ...
    ceUIkit.component('countdown', Countdown);
    ceUIkit.component('filter', Filter);
    ceUIkit.component('lightbox', Lightbox);
    ceUIkit.component('lightboxPanel', LightboxPanel);
    ceUIkit.component('notification', Notification);
    ceUIkit.component('parallax', Parallax$1);
    ceUIkit.component('slider', Slider$1);
    ceUIkit.component('sliderParallax', SliderParallax);
    ceUIkit.component('slideshow', Slideshow$1);
    ceUIkit.component('slideshowParallax', SliderParallax);
    ceUIkit.component('sortable', Sortable);
    ceUIkit.component('tooltip', Tooltip);
    ceUIkit.component('upload', Upload);
